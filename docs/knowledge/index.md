...
- [Search Index](concepts/search-index.md) - Offline full-text index enabling keyboard-driven querying.
- [Git Repository Mount](concepts/git-repository-mount.md) - Single-command mount over any local Git repository without polluting data.
